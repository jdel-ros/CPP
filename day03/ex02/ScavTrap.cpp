...
/*   Updated: 2021/03/05 12:30:25 by jdel-ros         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

ScavTrap::ScavTrap( void ): ClapTrap("Defaut", 100, 100, 100, 100, 1, 30, 5, 3)
{
	srand(time(NULL));
	std::cout << "The Saiyan " << this->_name << " arrived on Namek !" << std::endl;
}

ScavTrap::ScavTrap( std::string name ): ClapTrap(name, 100, 100, 100, 100, 1, 30, 5, 3)
{
	srand(time(NULL));
	std::cout << "The Saiyan " << this->_name << " arrived on Namek !" << std::endl;
}
